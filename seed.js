...
var { db, Place, Hotel, Restaurant, Activity } = require('./server/models');
  ...
  hotel: [
    {
      ...
      place: {
        ...
        state: 'Tokyo',
        phone: '123-123-1232',
        location: [139.691, 35.686],
      },
      num_stars: 5,
      amenities: 'Too rich for your blood',
    },
    {
      name: "Chris' House",
      place: {
        address: '1237 65th St',
        city: 'Brooklyn',
        state: 'NY',
        phone: '111-111-1111',
        location: [-74.003, 40.627],
      },
      num_stars: 1,
      amenities: 'Free Wifi, Chris',
    },
    {
